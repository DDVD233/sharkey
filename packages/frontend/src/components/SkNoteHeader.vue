...
<header v-if="!classic" :class="$style.root">
	...
	<div v-if="mock" :class="$style.time">
		<MkTime :time="note.createdAt" colored/>
	</div>
	<MkA v-else :class="$style.time" :to="notePage(note)">
		<MkTime :time="note.createdAt" colored/>
	</MkA>
	<span v-if="note.visibility !== 'public'" :class="$style.info" :title="i18n.ts._visibility[note.visibility]">
	...
	<span v-if="note.updatedAt" ref="menuVersionsButton" :class="$style.info" style="cursor: pointer;" title="Edited" @mousedown="menuVersions()"><i class="ph-pencil-simple ph-bold ph-lg"></i></span>
	<span v-if="note.localOnly" :class="$style.info" :title="i18n.ts._visibility['disableFederation']"><i class="ph-rocket ph-bold ph-lg"></i></span>
	<span v-if="note.channel" :class="$style.info" :title="note.channel.name"><i class="ph-television ph-bold ph-lg"></i></span>
	<SkInstanceTicker v-if="showTicker" :class="$style.ticker" style="cursor: pointer;" :instance="note.user.instance" :host="note.user.host" @click.stop="showOnRemote()"/>
</header>
