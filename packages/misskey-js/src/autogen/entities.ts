...
export type AdminCsamAddDenylistRequest = operations['admin___csam___add-denylist']['requestBody']['content']['application/json'];
export type AdminCsamAddDenylistResponse = operations['admin___csam___add-denylist']['responses']['200']['content']['application/json'];
export type AdminCsamDeleteDenylistRequest = operations['admin___csam___delete-denylist']['requestBody']['content']['application/json'];
export type AdminCsamListDenylistRequest = operations['admin___csam___list-denylist']['requestBody']['content']['application/json'];
export type AdminCsamListQuarantineRequest = operations['admin___csam___list-quarantine']['requestBody']['content']['application/json'];
export type AdminCsamResolveQuarantineRequest = operations['admin___csam___resolve-quarantine']['requestBody']['content']['application/json'];
...
export type AdminRecommendationBackfillAuthorEmbeddingsRequest = operations['admin___recommendation___backfill-author-embeddings']['requestBody']['content']['application/json'];
export type AdminRecommendationBackfillAuthorEmbeddingsResponse = operations['admin___recommendation___backfill-author-embeddings']['responses']['200']['content']['application/json'];
export type AdminRecommendationBackfillHistoryRequest = operations['admin___recommendation___backfill-history']['requestBody']['content']['application/json'];
export type AdminRecommendationBackfillHistoryResponse = operations['admin___recommendation___backfill-history']['responses']['200']['content']['application/json'];
export type AdminRecommendationBackfillQualityRequest = operations['admin___recommendation___backfill-quality']['requestBody']['content']['application/json'];
export type AdminRecommendationBackfillQualityResponse = operations['admin___recommendation___backfill-quality']['responses']['200']['content']['application/json'];
export type AdminRecommendationBackfillTopicsRequest = operations['admin___recommendation___backfill-topics']['requestBody']['content']['application/json'];
export type AdminRecommendationBackfillTopicsResponse = operations['admin___recommendation___backfill-topics']['responses']['200']['content']['application/json'];
export type AdminRecommendationPrefillRequest = operations['admin___recommendation___prefill']['requestBody']['content']['application/json'];
export type AdminRecommendationPrefillResponse = operations['admin___recommendation___prefill']['responses']['200']['content']['application/json'];
export type AdminRecommendationPurgeBlockedResponse = operations['admin___recommendation___purge-blocked']['responses']['200']['content']['application/json'];
export type AdminRecommendationRebuildUserVectorsResponse = operations['admin___recommendation___rebuild-user-vectors']['responses']['200']['content']['application/json'];
export type AdminRecommendationReindexQualityRequest = operations['admin___recommendation___reindex-quality']['requestBody']['content']['application/json'];
export type AdminRecommendationReindexQualityResponse = operations['admin___recommendation___reindex-quality']['responses']['200']['content']['application/json'];
export type AdminRecommendationStatsRequest = operations['admin___recommendation___stats']['requestBody']['content']['application/json'];
export type AdminRecommendationStatsResponse = operations['admin___recommendation___stats']['responses']['200']['content']['application/json'];
...
export type AdminSpamLogListRequest = operations['admin___spam-log___list']['requestBody']['content']['application/json'];
export type AdminSpamLogRestoreRequest = operations['admin___spam-log___restore']['requestBody']['content']['application/json'];
...
export type IRecommendationInterestsResponse = operations['i___recommendation-interests']['responses']['200']['content']['application/json'];
...
export type NotesRecommendationsRequest = operations['notes___recommendations']['requestBody']['content']['application/json'];
export type NotesRecommendationsResponse = operations['notes___recommendations']['responses']['200']['content']['application/json'];
export type NotesRecommendationsDwellRequest = operations['notes___recommendations___dwell']['requestBody']['content']['application/json'];
export type NotesRecommendationsDwellResponse = operations['notes___recommendations___dwell']['responses']['200']['content']['application/json'];
export type NotesRecommendationsNotInterestedRequest = operations['notes___recommendations___not-interested']['requestBody']['content']['application/json'];
export type NotesRecommendationsNotInterestedResponse = operations['notes___recommendations___not-interested']['responses']['200']['content']['application/json'];
