...
export class ClientServerService {
	...
	private async generateCommonPugData(meta: MiMeta) {
		return {
			...
			serverErrorImageUrl: meta.serverErrorImageUrl ?? '/client-assets/dvd/screaming.webp',
			infoImageUrl: meta.infoImageUrl ?? '/client-assets/dvd/stare.webp',
			notFoundImageUrl: meta.notFoundImageUrl ?? '/client-assets/dvd/question.webp',
