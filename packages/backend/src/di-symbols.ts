...
export const DI = {
	...
	spamLogsRepository: Symbol('spamLogsRepository'),
	csamDenylistRepository: Symbol('csamDenylistRepository'),
	csamQuarantineRepository: Symbol('csamQuarantineRepository'),
